...
INSERT INTO producte VALUES(default, 'Botes LX-100', 'Fischer', 79.99, 0, true, true, 'Img/Producte_botes.jpg'),
	(default, 'Botes Pro Max', 'Fischer', 99.99, 0, true, true, 'Img/Producte_botes1.jpg'),
    (default, 'Botes Alltrack Pro', 'Rossignol', 100, 0, true, true, 'Img/Producte_botes2.jpg'),
    (default, 'Esquis Salomon 500', 'Salomon', 149.99, 0, true, true, 'Img/Producte_esqui.jpg'),
    (default, 'Esquis Rookie 90', 'Wedze', 74.99, 0, true, true, 'Img/Producte_esqui1.jpg'),
    (default, 'Esquis FR 100', ' Wedze', 99.99, 0, true, true, 'Img/Producte_esqui2.jpg'),
    (default, 'Pals FR950', 'Wedze', 19.99, 0, true, true, 'Img/Producte_pals.jpg'),
    (default, 'Pals Freeride', 'Inovik', 24.99, 0, true, true, 'Img/Producte_pals1.jpg'),
    (default, 'Pals XC Pole', 'Inovik', 20, 0, true, true, 'Img/Producte_pals2.jpg'),
    (default,'Casco heyya Pro Set','uvex','134.99','0',true,true,'Img/Producte_casco.jpg'),
    (default,'Casco Neo IPS','Giro','119.99','0',true,true,'Img/Producte_casco1.jpg'),
    (default,'Casco Skihelm','Black Crevice','139.99','0',true,true,'Img/Producte_casco2.jpg');
